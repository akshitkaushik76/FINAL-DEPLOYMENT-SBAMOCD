...
router.route('/update-quantity/:branch_id/:business_code').patch(auth_controller.protect_owner,product_controller.updatequantity);
router.route('/delete-product/:business_code/:branch_id').delete(auth_controller.protect_owner,product_controller.delete_product_information);
